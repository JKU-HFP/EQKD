...
namespace EQKDServer.Models.Hardware
{
    public class Connections: Catalogue
    {
        ...
        public bool ConnectLinearStages(Action<string> _loggerCallback, string port = "M-505.2DG\nM-505.2DG")
        {
            try
            {
        ...
        public bool ConnectRotationStages(Action<string> _loggerCallback, string port = "COM3")
        {
            try
            {
